...
namespace Nocturnal.src.events.prologue
{
    public static class NightclubEdenEvents
    {
        ...
        {
            await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.ENTER_01")}");
            await Task.Delay(1000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.ENTER_02")}");
            await Task.Delay(1000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.ENTER_03")}");
            await Task.Delay(1000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.ENTER_04")}");

            _ = new InteractiveMenu(new MenuOptions
            {
                { LocalizationService.GetString("NIGHTCLUB_EDEN.ENTER_MENU.GO_TO_DANCE_FLOOR"), ClubDanceFloor },
                { LocalizationService.GetString("NIGHTCLUB_EDEN.ENTER_MENU.GO_TO_BAR"), ClubBar },
                { LocalizationService.GetString("NIGHTCLUB_EDEN.ENTER_MENU.GO_UPSTAIRS"), ClubUpstairs },
                { LocalizationService.GetString("NIGHTCLUB_EDEN.ENTER_MENU.BACK_ON_STREET"), PrologueEvents.VisitStreet },
            });
        }
        ...
        public static async Task ClubDanceFloor()
        {
            ...
            {
                await Display.WriteNarration($"\t{LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_01")}");
                await Task.Delay(1000);
                await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_02")}");
                await Task.Delay(1500);
                await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_03")}");
                await Task.Delay(1500);
                await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_04")}");
                await Task.Delay(1000);
                await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_05")}");
                await Task.Delay(1500);
                await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_06")}");

                _ = new InteractiveMenu(new MenuOptions
                {
                    { LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_MENU.WHATS_SHE_WANTS"), ClubDanceFloor_01 },
                    { LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_MENU.HEY_BABY"), ClubDanceFloor_02 },
                    { LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_MENU.KEEP_DANCING"), ClubDanceFloor_03 },
                });
            ...
            else
            {
                await Display.WriteNarration($"\t{LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_01")}");
                await Task.Delay(1000);
                await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_07")}");
                await Task.Delay(1500);
                await Crossroads();
            }
        }
        ...
        public static async Task ClubDanceFloor_02()
        {
            ...
            await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.DANCE_FLOOR_11")}");
        ...
        public static async Task ClubBar()
        {
            ...
            _ = new InteractiveMenu(new MenuOptions
            {
                { LocalizationService.GetString("NIGHTCLUB_EDEN.BAR_MENU.GIVE_ANYTHING"), ClubBar_01 },
                { LocalizationService.GetString("NIGHTCLUB_EDEN.BAR_MENU.WHO_RULES"), ClubBar_02 },
                { LocalizationService.GetString("NIGHTCLUB_EDEN.BAR_MENU.BYE"), ClubBar_03 },
            });
        }
        ...
        public static async Task ClubBar_01()
        {
            ...
            await Task.Delay(1000);
            await Display.WriteDialogue($" {LocalizationService.GetString("NIGHTCLUB_EDEN.BAR_04")}");
            await Task.Delay(1500);
            await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.BAR_05")}");
            await Task.Delay(1500);
            await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.BAR_06")}");
            await Task.Delay(1000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.BAR_07")}.");
            await Display.WriteDialogue($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.BAR_08")}");
            await ClubBar();
        }
        ...
        public static async Task ClubBar_02()
        {
            ...
            await Task.Delay(1500);
            await Display.WriteDialogue($" {LocalizationService.GetString("NIGHTCLUB_EDEN.BAR_11")}");
            await Task.Delay(1000);
            await Display.WriteDialogue($" {LocalizationService.GetString("NIGHTCLUB_EDEN.BAR_12")}");
            await ClubBar();
        }
        ...
        public static async Task LunaMeeting()
        {
            ...
            _ = new InteractiveMenu(new MenuOptions
            {
                { LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_MENU.WHATS_IT_ABOUT"), LunaMeeting_01 },
                { LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_MENU.LET_HER_SPEAK"), LunaMeeting_02 }
            });

            await Display.WriteDialogue($"\t{LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_01")}");
            await Task.Delay(1000);
            await Display.WriteDialogue($" {LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_02")}");
            await Globals.Player.AddQuest(Globals.Quests["KillHex"]);
            Console.WriteLine();
            await Task.Delay(1500);
            await Display.WriteNarration($"\t{LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_03")}");
            await Display.WriteDialogue($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_04")}");

            if (Globals.Player.HasItem(Globals.Items["Pistol"]))
            {
                await Display.WriteDialogue($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_05")}");
                await Task.Delay(1000);
                await Display.WriteDialogue($" {LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_06")}");
            }
            else
            {
                await Display.WriteDialogue($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_07")}");
                await Task.Delay(1000);
                await Display.WriteDialogue($" {LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_08")}");
                ...
                await Display.WriteDialogue($"\t{LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_09")}");
                await Display.WriteDialogue($" {LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_10")}");
                await Task.Delay(1000);
                await Display.WriteDialogue($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_MEETING_11")}");
            }
        ...
        public static async Task ClubUpstairs()
        {
            ...
            _ = new InteractiveMenu(new MenuOptions
            {
                { LocalizationService.GetString("NIGHTCLUB_EDEN.UPSTAIRS_MENU.COME_CLOSER"), ClubUpstairs_01 },
                { LocalizationService.GetString("NIGHTCLUB_EDEN.UPSTAIRS_MENU.GO_BACK"), ClubUpstairs_02 }
            });
        }
        ...
        public static async Task DialogueWithJet()
        {
            ...
            options.Add(LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_JET_MENU.I_WANT_PASS"), DialogueWithJet_01);
            options.Add(LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_JET_MENU.WHATS_THERE"), DialogueWithJet_02);

            if (Globals.Player.HasItem(Globals.Items["Pistol"]) || Globals.Player.Weapon == Globals.Items["Pistol"])
            {
                options.Add(LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_JET_MENU.KILL"), DialogueWithJet_03);
                options.Add(LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_JET_MENU.STUN"), DialogueWithJet_04);
            }

            options.Add(LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_JET_MENU.BYE"), DialogueWithJet_05);
        ...
        public static async Task DialogueWithJet_03()
        {
            ...
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_JET_07")}");
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_JET_08")}\n");
            await HexOffice();
        }
        ...
        public static async Task DialogueWithJet_04()
        {
            ...
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_JET_11")}");
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_JET_12")}\n");
            await HexOffice();
        }
        ...
        public static async Task WakeUpAfterMeetingWithJet()
        {
            ...
            await Task.Delay(1000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.GET_STUNNED_02")}", 60);
            await Task.Delay(1500);
            await Display.WriteNarration(LocalizationService.GetString("NIGHTCLUB_EDEN.GET_STUNNED_03"));
            await Task.Delay(1500);
            await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.GET_STUNNED_04")}");
            await Task.Delay(1000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.GET_STUNNED_05")}");
            await Task.Delay(500);
            await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.GET_STUNNED_06")}");
            await Task.Delay(1000);
        ...
        public static async Task HexOffice()
        {
            ...
            _ = new InteractiveMenu(new MenuOptions
            {
                { LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_OFFICE_MENU.GO_TO_OTHER_ROOM"), HexHideoutCode },
                { LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_OFFICE_MENU.STAY_AND_SEARCH"), CheckHexDesk }
            });
        }
        ...
        public static async Task HexHideoutCode()
        {
            ...
            {
                await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_CODE_02")}");
                Console.WriteLine();
                await CheckHexDesk();
                return;
            }
            ...
            _ = new InteractiveMenu(new MenuOptions
            {
                { LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_CODE_MENU.USE_CODE"), RightAccessCode },
                { LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_CODE_MENU.SEARCH_OFFICE"), CheckHexDesk }
            });
        }
        ...
        public static async Task HexHideout()
        {
            ...
            await Task.Delay(2000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_02")}");
            await Task.Delay(1500);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_03")}");
            await Task.Delay(2000);
            await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_04")}");

            _ = new InteractiveMenu(new MenuOptions
            {
                { LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_MENU.KILL"), HexHideout_01 },
                { LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_MENU.WAIT"), HexHideout_02 }
            });
        }
        ...
        public static async Task HexHideout_01()
        {
            ...
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_06")}");
            await LunaAppears();
        }
        ...
        public static async Task HexHideout_02()
        {
            ...
            await Task.Delay(1000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_08")}");
            await Task.Delay(1500);
            Globals.Npcs["HexFolstam"].Status = NpcStatus.Normal;
            await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_09")}");
            await Task.Delay(1000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_10")}");
            await Display.WriteDialogue($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_HIDEOUT_11")}");
        ...
        public static async Task DialogueWithHex()
        {
            await Task.Run(() =>
            {
                _ = new InteractiveMenu(new MenuOptions
                {
                    { LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_HEX_MENU_01.DIE"), DialogueWithHex_01 },
                    { LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_HEX_MENU_01.DONT_WANNA_FIGHT"), DialogueWithHex_02 },
                    { LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_HEX_MENU_01.LUNA_WANTS_YOU_DEAD"), DialogueWithHex_03 }
                });

                _ = new InteractiveMenu(new MenuOptions
                {
                    { LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_HEX_MENU_02.DOESNT_MATTER"), DialogueWithHex_04 },
                    { LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_HEX_MENU_02.LUNA"), DialogueWithHex_05 }
                });
            });
        }
        ...
        public static async Task LunaAppears()
        {
            ...
            await Task.Delay(1000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_APPEARS_02")}");
            await Display.WriteDialogue($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_APPEARS_03")}");
            await Task.Delay(1500);
            await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_APPEARS_04")}");
            await Task.Delay(1000);
            await Display.WriteDialogue($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_APPEARS_05")}");
            await Task.Delay(1000);
            await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_APPEARS_06")}");

            _ = new InteractiveMenu(new MenuOptions
            {
                { LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_APPEARS_MENU.DO_NOTHING"), DialogueWithHex_06 },
                { LocalizationService.GetString("NIGHTCLUB_EDEN.LUNA_APPEARS_MENU.WHAT_ITS_ABOUT"), DialogueWithHex_07 }
            });
        ...
        public static async Task DialogueWithHex_01()
        {
            ...
            await Task.Delay(1000);
            await Display.WriteDialogue($" {LocalizationService.GetString("NIGHTCLUB_EDEN.DIA_HEX_03")}");
            await Task.Delay(1000);
        ...
        public static async Task HexDeath()
        {
            ...
            await Task.Delay(1000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_DEATH_02")}");
            await Task.Delay(1500);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_DEATH_03")}");
            Globals.Npcs["HexFolstam"].Status = NpcStatus.Dead;
            await Display.WriteNarration($"\n\t{LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_DEATH_04")}");
            await Task.Delay(1000);
            await Display.WriteNarration($" {LocalizationService.GetString("NIGHTCLUB_EDEN.HEX_DEATH_05")}");
            await LunaAppears();
        }
